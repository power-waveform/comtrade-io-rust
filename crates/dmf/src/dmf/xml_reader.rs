...
//!
//! 各设备元素的属性解析函数位于 [`super::elements`]，本文件只负责
//! XML 事件流到 DMF 结构的分派挂载。
...
use super::elements::{
    attr, attr_f64, attr_str, attr_usize, parse_acc_attrs, parse_acv_attrs, parse_analog_attrs,
    parse_bus_attrs, parse_exciter_attrs, parse_generator_attrs, parse_line_attrs,
    parse_status_attrs, parse_transformer_attrs, parse_winding_attrs,
};
use super::*;
use cbase::equipment::{
    Bus, Capacitance, Exciter, Generator, Igap, Impedance, Line, MutualInductance, Px, Transformer,
    TransformerWinding,
};
...
<scl:ComtradeModel station_name="S" version="1.0" reference="0" rec_dev_name="R">
    ...
    <scl:Exciter idx="6" exc_name="E1" srcRef="" sys_ID="" pwr_ID="5,G1" object_type="PRIMARY" freq="100" V1="0.5">
        ...
        let text = super::xml_writer::write_dmf(&dmf1);
